...
namespace JJ
{
    public class WeaponInventorySlot : MonoBehaviour
    {
        ...
        public void EquipThisItem()
        {
            ...
            playerInventory.rightWeapon = playerInventory.weaponsInRightHandSlots[playerInventory.currRightWeaponIdx];
            playerInventory.leftWeapon = playerInventory.weaponsInLeftHandSlots[playerInventory.currLeftWeaponIdx];
